...
/**
 * done 1 llamar metodo math y almacenar el numero aleatorio done 2 llamar
 * metodo PedirNumero done 3 comparar nº introducido y nº generado
 * 
 * done 4 si es > indicarlo si es < indicarlo (if else) 5 Usar do while 5 veces.
 */
