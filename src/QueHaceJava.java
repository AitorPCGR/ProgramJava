...
{ 
	...
	{ 
        QueHace qh1 = null; 	//creas la variable String qh1
        QueHace qh2 = null;		//creas la variable	String qh2
 
        qh1 = new QueHace();	//permites que la variable qh1 pueda almacenar datos
